...
//{{{ begin codeInclude
#line 43 "/media/ali/8TB_External/Post_Doc_stuff/MHI_cases/PeriodicHill/periodicHill/steadyState_2D/system/blockMeshDict.#codeStream"
...
extern "C"
{
    ...
    {
//{{{ begin code
        #line 49 "/media/ali/8TB_External/Post_Doc_stuff/MHI_cases/PeriodicHill/periodicHill/steadyState_2D/system/blockMeshDict.#codeStream"
const scalar xMin = 0;
